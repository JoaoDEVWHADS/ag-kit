...
Kit version: `2026.7.18` · 21 agents · 48 skills · 14 workflows
...
flowchart LR
  ...
  subgraph Agents
    ...
    A_teamtalk_developer["teamtalk-developer"]
  ...
  W_create_tt_bot --> A_teamtalk_developer
  W_create_tt_bot -.-> S_teamtalk_sdk
  ...
  A_teamtalk_developer --> S_teamtalk_sdk
  A_teamtalk_developer --> S_clean_code
  A_teamtalk_developer --> S_api_patterns

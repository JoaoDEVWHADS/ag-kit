...
export const dictionaries: Record<Locale, Dict> = {
    en: {
        ...
        agentsPage: {
            ...
            tipTextB: " agent to dispatch exactly three independent analyses before waiting, review each result, and then synthesize.",
        ...
        installPage: {
            ...
            agentDirDesc: "Contains 21 specialist AI agent configurations for different domains (frontend, backend, security, etc.)",
            skillsDirDesc: "48 domain-specific knowledge modules that agents can use",
            workflowsDirDesc: "14 slash command procedures for common development tasks",
    ...
    vi: {
        ...
        agentsPage: {
            ...
            tipTextB: " để giao đúng ba phân tích độc lập trước khi chờ, xem xét từng kết quả rồi mới tổng hợp.",
        ...
        installPage: {
            ...
            agentDirDesc: "Chứa 21 cấu hình AI agent chuyên biệt cho các lĩnh vực khác nhau (frontend, backend, bảo mật, v.v.)",
            skillsDirDesc: "48 mô-đun kiến thức theo lĩnh vực mà agent có thể sử dụng",
            workflowsDirDesc: "14 thủ tục lệnh gạch chéo cho những tác vụ phát triển thường gặp",
    ...
    zh: {
        ...
        agentsPage: {
            ...
            tipTextB: " agent 在等待前分派恰好三个独立分析，逐一审阅后再综合。",
        ...
        installPage: {
            ...
            agentDirDesc: "包含 21 个面向不同领域（前端、后端、安全等）的专业 AI agent 配置",
            skillsDirDesc: "48 个 agent 可使用的特定领域知识模块",
            workflowsDirDesc: "14 个用于常见开发任务的斜杠命令流程",
    ...
    ja: {
        ...
        agentsPage: {
            ...
            tipTextB: " agent を使い、待機前に独立分析を必ず 3 つディスパッチし、各結果を確認してから統合します。",
        ...
        installPage: {
            ...
            agentDirDesc: "さまざまな領域（フロントエンド、バックエンド、セキュリティなど）向けの 21 個の専門 AI agent 設定を含みます",
            skillsDirDesc: "agent が使用できる 48 個のドメイン固有の知識モジュール",
            workflowsDirDesc: "よくある開発タスク向けの 14 個のスラッシュコマンド手順",
